...
/*Font Family Name*/
$wp_customize->add_setting('opus_blog_options[opus-blog-font-family-name]', array(
    'capability' => 'edit_theme_options',
    'transport' => 'refresh',
    'default' => $default['opus-blog-font-family-name'],
    'sanitize_callback' => 'wp_kses_post'
));
$choices = opus_blog_google_fonts();
$wp_customize->add_control('opus_blog_options[opus-blog-font-family-name]', array(
    'label' => __('Font Name', 'opus-blog'),
    'description' => __('Select Font Family Name, Example: Barlow Semi Condensed, sans-serif', 'opus-blog'),
    'choices'  	=> $choices,
    'section' => 'opus_blog_font_options',
    'settings' => 'opus_blog_options[opus-blog-font-family-name]',
    'type' => 'select',
    'priority' => 15,
));
/*Paragraph font Size*/
