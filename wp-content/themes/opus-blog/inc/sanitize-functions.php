 ...
 */
function opus_blog_sanitize_checkbox($checked)
{
    // Boolean check.
 ...
 */
function opus_blog_sanitize_select($input, $setting)
{
 ...
 *                    the setting default.
 */
function opus_blog_sanitize_number_range($number, $setting)
{
...
// Custom Controls
function opus_blog_sanitize_custom_control( $input ) {
    return $input;
}
