        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="site-info">
                        <a href="<?php echo esc_url(__('https://wordpress.org/', 'opus-blog')); ?>">
                            <?php
                            /* translators: %s: CMS name, i.e. WordPress. */
                            printf(esc_html__('Proudly powered by %s', 'opus-blog'), 'WordPress');
                            ?>
                        </a>
                        <span class="sep"> | </span>
                        <?php
                        /* translators: 1: Theme name, 2: Theme author. */
                        printf(esc_html__('Theme: %1$s by %2$s.', 'opus-blog'), 'Opus Blog', '<a href="https://www.akithemes.com/">Aki Themes</a>');
                        ?>
                    </div>
                </div>
                <div class="col-md-6">
