...
function opus_blog_scripts()
{
    ...
    $opus_blog_body_fonts = $opus_blog_theme_options['opus-blog-font-family-name'];
    $opus_blog_body_font = $opus_blog_google_fonts[$opus_blog_body_fonts];
...
add_action('wp_enqueue_scripts', 'opus_blog_scripts');
...
require get_template_directory() . '/inc/tgm/tgm-plugin-recommendation.php';
